...
export default function Index() {
  return (
    ...
    >
      <Head>
        <title>AndrewWeisbeck.dev</title>
        <meta name="description" content="The Fullstack Framework in Deno." />
      </Head>
      <p className="logo">
        <img src="./assets/hackermindset.png" width="450" height="300" title="Aleph.js" />
      </p>
      <h1 className="text-3xl font-bold mb-2 mt-2">
        Welcome to my personal developer site created on Deno!
      </h1>
      <p className="text-center text-md max-w-180 text-gray-800">
        My name is <strong>Andrew Weisbeck</strong> and I am a <em>Full-Stack Developer</em> located in Raleigh, NC. I am currently seeking full-time employment as well as taking new freelance jobs. Give me a shout!
      </p>
      ...
      <nav className="mt-8">
        ...
        <Link
          className="inline-flex items-center justify-center w-60 h-12 border-1 border-gray-300 rounded-full hover:border-gray-400 transition-colors duration-300 ml-4"
          role="button"
          to="/contact"
        >
          Contact Me
